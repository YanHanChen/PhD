...
#' @param t a vector of nonnegative integers specifying the sampling units in each community. Ignored if \code{datatype = "abundance"}.\cr
...
#' @param datatype data type of input data: individual-based abundance data (\code{datatype = "abundance"}),
#' or species by sampling-units incidence matrix (\code{datatype = "incidence_raw"}), default is "abundance". \cr
#' @param t a vector of nonnegative integers specifying the sampling units in each community.
